export const Votacion = (props: any) => {
    return (
        <a
            ...
            className="grid rounded-2xl overflow-hidden border-solid border-[5px] border-red-700 p-2 bg-[#fef2f2] w-full"
        >
            <h6 className="font-bold text-xl text-red-700">{props.titulo}</h6>
            <p className="text-gray-600 font-bold">{props.descripcion}</p>
