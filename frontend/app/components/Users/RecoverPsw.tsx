...
const RecoverPsw = () => {
    ...
    const fieldsConfig =
        "appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded p-2.5 mb-1 leading-tight focus:outline-none focus:bg-white";
    ...
    const onSubmit = handleSubmit((data: any) => {
        try {
            ...
            axios
                .put(USUARIOS_API_BASE_URL, request, {
                    headers: {
    ...
    return (
        <div className="mx-auto my-8 w-[70%]">
            <Toaster />
            <h2 className="text-black text-2xl">Actualizar Contraseña</h2>
            ...
            <form className="w-full max-w-lg mx-auto" onSubmit={onSubmit}>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <label
                            className="block tracking-wide text-gray-700 text-sm font-bold mb-2"
                            htmlFor="confContrasenia"
                        >
                            Confirmar contraseña nueva:
                        </label>
                        {errors.confContrasenia && (
                            <span className="text-red-500 text-xs italic">
                                {errors.confContrasenia.message as string}
                            </span>
                        )}
                        <input
                            id="confContrasenia"
