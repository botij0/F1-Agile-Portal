        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/api/v1/votaciones/**").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/v1/votaciones").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/v1/usuarios/**").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/v1/usuarios/solicitudes/**").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/v1/circuitos/**").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/v1/circuitos/**").hasAuthority("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/v1/circuitos/**").hasAuthority("ADMIN")
