  ...
  return (
    <div className="mt-[20px]  max-w-[90%] mx-auto">
      ...
      <div style={{ display: "flex" }}>
        <div>
          <div>
            <h1 className="text-xl  mt-5 font-bold">Gasto de combustible</h1>
        ...
        <div className="ml-20">
          <div>
            ...
            <p className="text-xs text-gray-500 my-1">
              Sistema de recuperación de energía en frenadas que se almacena en
              una batería.
            </p>
            <div>
              <div className="my-3">
              ...
              <div style={{ display: "flex" }}>
                ...
                <div className="my-3 ml-8">
                  <label className="block mb-1 text-sm font-medium text-gray-900">
                    Número de vueltas necesarias para cargar la batería:
                  </label>
                  <input
                    disabled={true}
                    type="number"
