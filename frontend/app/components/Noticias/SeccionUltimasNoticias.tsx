...
export const SeccionUltimasNoticias = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const { initTE } = require("tw-elements");
      initTE({ Carousel });
    }
    getNoticias();
    setLoading(false);
  ...
  return (
    <>
      {loading && <SkeletonSeccionUltimasNoticias />}
      {!loading && noticias && (
        <div
          id="carouselExampleCaptions"
          className="relative max-w-[900px] h-[524px] mt-5 group bg-red-700 rounded-3xl overflow-hidden border-solid border-8 border-red-700 mx-auto"
        ...
        >
          ...
          >
            <button
              ...
              className="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent
                        bg-white bg-clip-padding p-0-indent-[999px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] 
            ...
            <button
              ...
              className="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] 
                        border-solid border-transparent bg-white bg-clip-padding p-0-indent-[999px] opacity-50 transition-opacity 
                        duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
              aria-label="Slide 2"
            ></button>
            <button
              type="button"
          ...
          <div className="relative w-[900px] overflow-hidden after:clear-both after:block after:content-['']">
            {/*First item*/}
            <div
              className="relative float-left -mr-[100%] w-full transition-transform duration-[400ms] ease-in-out motion-reduce:transition-none overflow-hidden  data-[te-carousel-fade]:opacity-100 data-[te-carousel-fade]:z-[1]"
              data-te-carousel-active
