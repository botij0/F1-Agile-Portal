...
import PilotoRow from "@/app/components/Pilotos/PilotoRow";
...
const PilotosMng = () => {
    ...
    const pagiantePilotos = paginate(Pilotos, currentPage, pageSize);
    ...
    const deletePilotos = (e: React.MouseEvent, id: number) => {
        e.preventDefault();
    ...
    return (
        <div className="container mx-auto my-8">
            <h2 className="text-black text-2xl">Gestión de Pilotos</h2>
