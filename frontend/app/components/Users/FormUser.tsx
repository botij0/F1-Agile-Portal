...
const FormUser = () => {
    ...
    const onSubmit = handleSubmit((data: any) => {
        ...
        try {
            const request = {id: id ,nombre: data.nombre, username: data.usuario, email: data.email, rol: data.rol};
            console.log(request);
    ...
    if (id != undefined) {
        useEffect(() => {
            (async () => {
                try
                {
                    const response = await axios.get(USUARIOS_API_BASE_URL + "/" + id , {
                        headers: headers
                    });
  ...
  return (
    <div className='container mx-auto my-8'>
        ...
        <form className="w-full max-w-lg mx-auto" onSubmit={onSubmit}>
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
                                    ...
                                    id="nombre" type="text" placeholder="Nombre" {...register("nombre",{
                                        required:{
                                            value: true,
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="usuario">
                        Usuario
                    </label>
                    {
                        errors.usuario && (
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
                                     p-2.5 mb-1 leading-tight focus:outline-none focus:bg-white"
                                    id="email" type="email" placeholder="email@email.com" {...register("email",{
                                        required:{
                                            value: true,
                                            message: 'Este campo es obligatorio'
                                        },                                                
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <select className=" block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
                                    p-2.5 mb-1 leading-tight focus:outline-none focus:bg-white"
                                    id="rol" {... register("rol",{
                                        required:{
                                            value: true,
