            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div className="mt-4   flex flex-col justify-center items-center">
                        {isOver && (
                            <h3 className="text-xl font-bold my-8 bg-red-500 px-4 py-2.5 rounded-2xl text-white">
                                Votación finalizada
                            </h3>
                        )}
                        {!showResults ? (
                        ...
                        {votacion.opciones?.map((opcion: any) => (
                            ...
                            >
                                <div className="bg-gray-100 mb-2 rounded-lg flex px-4">
                                    ...
                                    <label
                                        htmlFor={opcion.id}
                                        className="ml-2 flex items-center relative gap-2 w-96 mb-2 p-2.5 rounded-lg"
                                    >
                                        <img
                                            src={
                                        ...
                                        <div>
                                            <p className="text-lg font-bold">
                                                {opcion.piloto.nombre +
                                                    " " +
                                                    opcion.piloto.apellidos}
                                            </p>
                                            <p className="text-sm">
                                                {opcion.piloto.equipo.nombre}
                                            </p>
                                            {showResults && (
                                                <div>
                                                    {" "}
