    ...
    return (
        ...
        >
            ...
            <div className="relative w-[900px] overflow-hidden after:clear-both after:block after:content-['']">
                ...
                <div
                    className="relative float-left -mr-[100%] w-full transition-transform duration-[400ms] ease-in-out motion-reduce:transition-none overflow-hidden hidden data-[te-carousel-fade]:opacity-100 data-[te-carousel-fade]:z-[1]"
                    data-te-carousel-active
